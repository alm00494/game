...
public class TileMap {
    ...
    /**
     * Gets the tile index of the tile at position 'x,y' in the tile map
     *
     * @param x The x tile coordinate (in tiles, not pixels)
     * @param y The y tile coordinate (in tiles, not pixels)
    ...
    /**
     * Gets the tile character at the tile index 'tileIndex'
     *
     * @param tileIndex The index of the tile in the tileset
     * @return tileChar - the character the tile is currently set to.
     */
